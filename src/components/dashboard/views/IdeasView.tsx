    ...
    <div className="p-6 space-y-8 max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-xs md:text-sm text-slate-600 dark:text-slate-300 mt-1 font-anthropic">Decizii la nivelul clubului, supuse votului democratic al membrilor</p>
        </div>
        {isAdmin && (
