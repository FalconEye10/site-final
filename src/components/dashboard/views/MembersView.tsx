  ...
  return (
    <div className="space-y-6 md:space-y-8 font-anthropic">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-4 font-anthropic">
        {[
          { label: 'Total Membri', numValue: totalMembri, suffix: '', icon: Users, color: 'text-blue-700 dark:text-blue-400', bg: 'bg-blue-100 dark:bg-blue-950/50' },
          { label: 'Membri Activi', numValue: membriActivi, suffix: '', icon: Activity, color: 'text-emerald-700 dark:text-emerald-400', bg: 'bg-emerald-100 dark:bg-emerald-950/50' },
          { label: 'Membri Noi', numValue: membriNoi, suffix: '', icon: UserPlus, color: 'text-purple-700 dark:text-purple-400', bg: 'bg-purple-100 dark:bg-purple-950/50' },
          { label: 'Rată Retenție', numValue: rataRetentie, suffix: '%', icon: Clock, color: 'text-amber-700 dark:text-amber-400', bg: 'bg-amber-100 dark:bg-amber-950/50' }
        ].map((stat, i) => {
          const cardStyle = [
          ...
          return (
            <div key={i} className={`p-4 sm:p-5 transition-all duration-300 hover:shadow-sm ${cardStyle}`}>
              ...
              <div className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-slate-900 dark:text-white tracking-tight font-data">
        ...
        <div className="flex flex-col lg:flex-row gap-3 items-stretch lg:items-center justify-between">
          ...
          <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap justify-between lg:justify-end font-title">
            ...
            <button
              ...
              className={`lg:hidden flex items-center gap-1.5 px-2.5 py-1.5 rounded-[2px] border text-xs font-bold uppercase tracking-wider transition-all shrink-0 cursor-pointer ${
            ...
            >
              ...
              <ChevronDown size={13} className={`transition-transform duration-200 ${isMobileFilterOpen ? 'rotate-180' : ''}`} />
            </button>
            ...
            {isAdmin && (
              <button 
                ...
                className="btn-civic-primary px-3 py-1.5 text-xs font-bold flex items-center justify-center gap-1.5 shadow-xs cursor-pointer uppercase tracking-wider shrink-0"
              >
